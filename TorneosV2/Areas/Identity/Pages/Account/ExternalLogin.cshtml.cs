...
namespace TorneosV2.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        private Z110_Usuario CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Z110_Usuario)}'. " +
                    $"Ensure that '{nameof(Z110_Usuario)}' is not an abstract class and has a parameterless constructor, or alternatively " +
